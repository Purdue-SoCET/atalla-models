...
def main():
    ...
    asm = f"""
        ...
        add.vv   $22, $22, $23, 1                # partial sum 2 + partial sum 3
        add.vv   $24, $21, $22, 1                # layer mean sum in $24
        ...
        add.vv   $35, $34, $35, 1                # partial variance pair 0+1
        add.vv   $37, $36, $37, 1                # partial variance pair 2+3
        add.vv   $38, $35, $37, 1                # variance sum in $38
